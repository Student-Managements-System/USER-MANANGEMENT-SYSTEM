...
Label(root, text="Name:", bg="lightblue", font=("Arial", 12)).grid(row=1, column=0, sticky=W, padx=10, pady=5)
Label(root, text="Student ID:", bg="lightblue", font=("Arial", 12)).grid(row=2, column=0, sticky=W, padx=10, pady=5)
Label(root, text="Age:", bg="lightblue", font=("Arial", 12)).grid(row=3, column=0, sticky=W, padx=10, pady=5)
Label(root, text="Grade:", bg="lightblue", font=("Arial", 12)).grid(row=4, column=0, sticky=W, padx=10, pady=5)
...
id_entry = Entry(root, width=30, font=("Arial", 12))
age_entry = Entry(root, width=30, font=("Arial", 12))
grade_entry = Entry(root, width=30, font=("Arial", 12))
